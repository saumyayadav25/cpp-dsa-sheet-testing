...
export default function CompanyQuestionsList({
  ...
  const toggleRevision = (questionId: number) => {
    ...
    updateQuestionState(questionId, {
      isMarkedForRevision: !currentState?.isMarkedForRevision,
    });
  };
        ...
        {filteredQuestions.map((question) => (
          ...
          >
            ...
            <div className="flex flex-wrap gap-2">
              {Object.entries(question.links).map(
                ([platform, url]) =>
                  url && (
                    <a
                      key={platform}
